...
export const CANDLE_PDP_TEMPLATE: Template = {
  ...
  sections: [
    ...
    { id: "mood", type: "MoodGrid", variant: "cards", slot: "narrative", order: 3, visibility: true, spacing: "lg", animation: "fade", settings: {} },
    { id: "craft", type: "CraftDetails", variant: "list", slot: "narrative", order: 4, visibility: true, spacing: "lg", animation: "fade", settings: {} },
    { id: "artist", type: "ArtistFeature", variant: "feature", slot: "narrative", order: 5, visibility: true, spacing: "lg", animation: "fade", settings: {} },
    { id: "artwork", type: "ArtworkFeature", variant: "full", slot: "atmosphere", order: 6, visibility: true, spacing: "md", animation: "fade", settings: {} },
    { id: "artist-quote", type: "EditorialQuote", variant: "handwritten", slot: "narrative", order: 7, visibility: true, spacing: "lg", animation: "fade", settings: {} },
    { id: "lifestyle", type: "LifestyleFeature", variant: "feature", slot: "narrative", order: 8, visibility: true, spacing: "lg", animation: "fade", settings: {} },
    { id: "cultural", type: "EditorialQuote", variant: "hairline", slot: "narrative", order: 9, visibility: true, spacing: "lg", animation: "fade", settings: {} },
    { id: "details", type: "EditorialAccordion", variant: "list", slot: "narrative", order: 10, visibility: true, spacing: "lg", animation: "fade", settings: {} },
    { id: "related", type: "RelatedProducts", variant: "rail", slot: "closing", order: 11, visibility: true, spacing: "lg", animation: "fade", settings: {} },
  ],
};
