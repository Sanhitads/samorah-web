...
export const CANDLE_PDP_TEMPLATE: Template = {
  ...
  sections: [
    ...
    { id: "divider-memory", type: "EditorialDivider", variant: "line", slot: "narrative", order: 3, visibility: true, spacing: "md", animation: "fade", settings: {} },
    { id: "mood", type: "MoodGrid", variant: "cards", slot: "narrative", order: 4, visibility: true, spacing: "lg", animation: "fade", settings: {} },
    { id: "craft", type: "CraftDetails", variant: "list", slot: "narrative", order: 5, visibility: true, spacing: "lg", animation: "fade", settings: {} },
    { id: "artist", type: "ArtistFeature", variant: "feature", slot: "narrative", order: 6, visibility: true, spacing: "lg", animation: "fade", settings: {} },
    { id: "artwork", type: "ArtworkFeature", variant: "full", slot: "atmosphere", order: 7, visibility: true, spacing: "md", animation: "fade", settings: {} },
