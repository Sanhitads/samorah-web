      ...
      <div className="feat__inner">
        {isQuote ? (
          <blockquote className="feat__quote">
            ...
            {ctaLabel ? <div className="feat__cta"><Link href={href || "#"} className="btn btn-outline">{ctaLabel}</Link></div> : null}
          </blockquote>
        ) : (
          <div className="feat__card">
            ...
            <div className="feat__body">
              ...
              {ctaLabel ? <Link href={href || "#"} className="btn btn-outline feat__link">{ctaLabel}</Link> : null}
            </div>
          </div>
        )}
      </div>
