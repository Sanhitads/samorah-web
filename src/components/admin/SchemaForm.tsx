        ...
        <span className="sf-media">
          ...
          {pickerOpen ? (
            <MediaPicker
              ...
              onSelect={(url, focal, focalMobile, mobileUrl) => { onChange(url); onSibling?.(`${f.key}__focal`, focal ?? ""); onSibling?.(`${f.key}__focalMobile`, focalMobile ?? ""); onSibling?.(`${f.key}__mobile`, mobileUrl ?? ""); }}
