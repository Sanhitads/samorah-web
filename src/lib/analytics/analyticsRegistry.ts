...
export const ANALYTICS_WIDGETS: AnalyticsWidget[] = [
  ...
  w({ key: "exec.visitors", name: "Visitors Today", domain: "Marketing", component: "KpiCard", permission: "analytics.view", service: "ga4DataService", route: null, refreshIntervalMs: 120_000, dataSource: "ga4", visibility: "whenAvailable", displayOrder: 3, defaultSize: "sm", stage: 2 }),
  w({ key: "exec.conversion", name: "Conversion Rate", domain: "Marketing", component: "KpiCard", permission: "analytics.view", service: "ga4DataService", route: null, refreshIntervalMs: 120_000, dataSource: "ga4", visibility: "whenAvailable", displayOrder: 4, defaultSize: "sm", stage: 2 }),
  w({ key: "exec.aov", name: "Average Order Value", domain: "Finance", component: "KpiCard", permission: "analytics.view", service: "businessOverviewService", route: "/admin/orders", refreshIntervalMs: 300_000, dataSource: "orders", visibility: "always", displayOrder: 5, defaultSize: "sm", stage: 2 }),
  w({ key: "exec.pending", name: "Pending Orders", domain: "Operations", component: "KpiCard", permission: "analytics.view", service: "businessOverviewService", route: "/admin/orders?status=pending", refreshIntervalMs: 300_000, dataSource: "orders", visibility: "always", displayOrder: 6, defaultSize: "sm", stage: 2 }),
  w({ key: "exec.bestSeller", name: "Best Seller Today", domain: "Business", component: "KpiCard", permission: "analytics.view", service: "businessOverviewService", route: "/admin/products", refreshIntervalMs: 300_000, dataSource: "orders", visibility: "always", displayOrder: 7, defaultSize: "sm", stage: 2 }),
  w({ key: "exec.lowStock", name: "Low Stock Count", domain: "Inventory", component: "KpiCard", permission: "analytics.view", service: "businessOverviewService", route: "/admin/inventory", refreshIntervalMs: 300_000, dataSource: "inventory", visibility: "always", displayOrder: 8, defaultSize: "sm", stage: 2 }),
  w({ key: "exec.criticalAlerts", name: "Critical Alerts", domain: "Operations", component: "KpiCard", permission: "analytics.view", service: "commandCenterService", route: "/admin/incidents", refreshIntervalMs: 300_000, dataSource: "derived", visibility: "always", displayOrder: 9, defaultSize: "sm", stage: 2 }),
