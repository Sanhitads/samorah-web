...
- **Commerce test matrix** — `vitest` (`npm test`), 15 passing: single-product GST · composition · mixed 12%+18% (guards vs the single-rate ₹203.25 regression) · shipping GST · free-ship thresholds · promotion stacking/priority · reservation expiry · retry reuse · cancellation window · FY invoice numbering.
