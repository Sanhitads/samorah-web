...
>
> **Last updated:** 2026-06-26 · Phase 7 §1–§6 built. §6 "Words" (Editorial / Closing Voice) shipped (Decision 20): titleless single literary sentence, curated one-of-many, global vs campaign-specific voices (`config/voices.ts`), fade+10px reveal. Closing arc set: §7 Atmosphere Gallery → §8 Newsletter → footer. Next: §7.
...
- **In progress:** **Phase 7 — Homepage** (one editorial journey, built beat by
  ...
  **§5 Living with fragrance** (titleless one-spread diptych — The Air Chapters
  ...
  one literary sentence, titleless; Decision 20).
  Closing sequence (growing quieter): **§7 Atmosphere Gallery** → **§8 Newsletter**
  → dark footer. Next beat: **§7**.
