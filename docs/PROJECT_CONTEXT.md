...
>
> **Last updated:** 2026-06-26 · Phase 7 §1–§5 built. §5 "Living with fragrance" shipped (Decision 19): titleless one-spread diptych — The Air Chapters + The Ritual; photography-led, whole-plate clickable, curated & product-agnostic (`config/invitations.ts`), secondary tucked to the primary's lower third. Next: §6 — to be reconsidered (§4 absorbed the old Featured-Product slot).
...
- **In progress:** **Phase 7 — Homepage** (one editorial journey, built beat by
  ...
  **§5 Living with fragrance** (titleless one-spread diptych — The Air Chapters
  + The Ritual; Decision 19).
  Next beat: **§6** — *to be reconsidered* (the old "Featured Product" slot was
  absorbed by §4; likely social-proof / lifestyle / newsletter closing arc).
